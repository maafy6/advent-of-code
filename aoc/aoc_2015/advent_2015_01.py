...
def part1(data: str = DATA) -> int:
    ...
    :returns: The expected floor.
    """
    return len([i for i in data if i == "("]) - len([i for i in data if i == ")"])
...
def part2(data: str = DATA) -> int:
    ...
    :param data: Input data.
    :returns: The instruction number that causes Santa to enter the basement.
    """
