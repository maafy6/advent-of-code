...
def elf_say(value: str) -> str:
    """Calculate the elfsay version of the string.

    :param value: The digit string.
    :returns: The expanded value of the digit string.
    """
    current = None
    cur_count = 0
    output = ""
...
def part1(data: str = DATA) -> int:
    ...
    :returns: The length of the data string after 40 iterations.
    """
    for _ in range(40):
        data = elf_say(data.strip())
...
def part2(data: str = DATA) -> int:
    ...
    :param data: The input data.
    :returns: The length of the data string after 50 iterations.
    """
    for _ in range(50):
        data = elf_say(data.strip())
