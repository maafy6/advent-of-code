...
def parse_data(data: str, *, squash: bool = False) -> list[tuple[int, int]]:
...
def part1(data: str = DATA) -> int:
    ...
    """
    return math.prod(race_outcomes(t, d) for t, d in parse_data(data))
...
def part2(data: str = DATA) -> int:
    ...
    :returns: The solution.
    """
    return math.prod(race_outcomes(t, d) for t, d in parse_data(data, squash=True))
